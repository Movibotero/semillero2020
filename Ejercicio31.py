...
"Confeccionar un programa que pida por teclado la cantidad de piezas a procesar"
"y luego ingrese la longitud de cada perfil, sabiendo que la pieza cuya longitud"
"Este comprendida en el rango de 1.20 y 1.30 son aptas. Imprimir por pantalla"
